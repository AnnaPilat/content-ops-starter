  ...
  return (
    <div style={{ width: '100vw', height: '100vh', overflow: 'hidden' }}>
      <img
        ...
        alt="Full Screen"
        style={{ width: '100%', height: '100%', objectFit: 'cover' }} // will be overwritten via useEffect
      />

      {/* External Script */}
      <Script
        async
        src="https://widget.intelswift.com/script.js?tenantId=094f2d86-c31e-4a4c-b5b5-c890ee26399a&botId=6826a221b95e5d2c503d3e37&uuid=0e1dedcf-a678-4608-a75f-c244fb089a49&end=true"
      />
